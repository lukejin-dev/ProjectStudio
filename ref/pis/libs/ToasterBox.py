...
# Ported And Enhanced From wxWidgets Contribution (Aj Bommarito)
#
...
DEFAULT_TB_STYLE = wx.BORDER_STATIC | wx.STAY_ON_TOP | wx.FRAME_NO_TASKBAR
...
class ToasterBoxWindow(wx.Frame):
   ...
   def __init__(self, parent, parent2, tbstyle, windowstyle,
       ...
       wx.Frame.__init__(self, parent, wx.ID_ANY, "window", wx.DefaultPosition,
                         wx.DefaultSize, style=windowstyle | wx.CLIP_CHILDREN|wx.NO_BORDER)
