_plugin_module_info_ = [{"name":"FvTemplate",
                         "author":"ken",
                         "version":"1.0",
                         "description":"Provide doc/view for EFI firmware volume file",
                         "class":"FVTemplatePlugin"}]
...
class FVTemplatePlugin(core.plugin.ITemplatePlugin):
    def IGetDescription(self):
        return 'EFI Firmware Volume'
...
class FvDoc(docview.Document):
    ...
    def LoadObject(self, fileObject):
        ...
        view.SetValue(self._fvobj, mapfile)
        return True
...
class FvView(docview.View):
    ...
    def SetValue(self, fvobj, mapfile=None):
        self._fvobj   = fvobj
